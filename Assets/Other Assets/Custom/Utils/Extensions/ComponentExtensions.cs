...
public static class ComponentExtensions {
	...
	public static void SetActiveChildren(this Component parent, bool value) {
	...
	public static void DestroyChildrenImmediate(this Component parent) {
		parent.transform.DestroyChildrenImmediate();
	}
