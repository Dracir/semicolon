...
[RequireComponent(typeof(AudioHierarchyManager))]
[ExecuteInEditMode]
public class PDPlayer : Magicolo.AudioTools.Player {
	...
	public PDAudioItemManager moduleManager;
	...
	protected override void Awake() {
		...
		if (Application.isPlaying) {
			...
			moduleManager = new PDAudioItemManager(Instance);
	...
	/// <param name="soundName">The name of sound to be played. In Pure Data, use <c>[ureceive~ <paramref name="moduleName"/>_<paramref name="soundName"/>]</c> to receive the audio. Do not send this audio signal through a <c>[uspatializer~]</c> because it is already spatialized.</param>
	/// <param name="source">The source around which the module and audio source will be spatialized. If a source is already provided in the inspector, it will be overriden. In Pure Data, send the audio that you want spatialized through a <c>[uspatializer~ <paramref name="moduleName"/>]</c>.</param>
	...
	public static AudioItem Play(string moduleName, string soundName, GameObject source) {
		return instance.moduleManager.Play(moduleName, soundName, source);
	}
	...
	public static AudioItem Play(string moduleName, string soundName) {
		return instance.moduleManager.Play(moduleName, soundName);
	}
	...
	/// </summary>
	/// <param name="moduleName">The name of the module to be played. If the module doesn't exist, one will be created with the default settings.</param>
	/// <param name="source">The source around which the module will be spatialized. If a source is already provided in the inspector, it will be overriden. In Pure Data, send the audio that you want spatialized through a <c>[uspatializer~ <paramref name="moduleName"/>]</c>.</param>
	/// <returns>The AudioItem that will let you control the module.</returns>
	public static AudioItem Play(string moduleName, GameObject source) {
		return instance.moduleManager.Play(moduleName, source);
	}
	...
	public static AudioItem Play(string moduleName) {
		return instance.moduleManager.Play(moduleName);
	}

	/// <summary>
	/// Pauses any audio signals going through a <c>[uspatializer~ <paramref name="moduleName"/>]</c> and any AudioSource connected to the module. In Pure Data, you can receive the pause command (float 0) with a <c>[receive <paramref name="moduleName"/>_Pause]</c>.
	/// </summary>
	/// <param name="moduleName">The name of the module to be paused.</param>
	public static void Pause(string moduleName) {
		instance.moduleManager.Pause(moduleName);
	}

	/// <summary>
	/// Stops any audio signals going through a <c>[uspatializer~ <paramref name="moduleName"/>]</c> and any AudioSource connected to the module. In Pure Data, you can receive the stop command (float 0) with a <c>[receive <paramref name="moduleName"/>_Stop]</c>.
	/// </summary>
	/// <param name="moduleName">The name of the module to be stopped.</param>
	public static void Stop(string moduleName) {
		instance.moduleManager.Stop(moduleName);
	}
	...
	public static float GetVolume(string moduleName) {
		return instance.moduleManager.GetVolume(moduleName);
	}
	...
	public static void SetVolume(string moduleName, float targetVolume, float time) {
		instance.moduleManager.SetVolume(moduleName, targetVolume, time);
	}
	...
	public static void SetVolume(string moduleName, float targetVolume) {
		instance.moduleManager.SetVolume(moduleName, targetVolume);
	}
	...
	/// </summary>
	/// <param name="patchName">The name of the patch to be opened relative to <c>Assets/Resources/<paramref name="patchesPath"/>/</c></param>
	...
	/// </summary>
	/// <param name="patchesName">The name of the patches to be opened relative to <c>Assets/Resources/<paramref name="patchesPath"/>/</c></param>
	...
	/// Closes a patch.
	/// </summary>
	/// <param name="patchName">The name of the patch to be closed.</param>
	...
	/// Closes patches.
	/// </summary>
	/// <param name="patchesName">The name of the patches to be closed.</param>
