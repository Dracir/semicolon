...
public class PDPlayer : Magicolo.AudioTools.Player {
	...
	public static AudioItem Play(string moduleName, string soundName, GameObject source, float delay, SyncMode syncMode, params AudioOption[] audioOptions) {
		return instance.itemManager.Play(moduleName, soundName, source, delay, syncMode, audioOptions);
	}
	
	public static AudioItem Play(string moduleName, string soundName, GameObject source, float delay, params AudioOption[] audioOptions) {
		return instance.itemManager.Play(moduleName, soundName, source, delay, SyncMode.None, audioOptions);
	}
