...
namespace Magicolo.AudioTools {
	...
	public class AudioPlayerEditorHelper : EditorHelper {
		...
		static AudioPlayerEditorHelper instance;
		
		public AudioPlayerEditorHelper(AudioPlayer audioPlayer) {
			this.audioPlayer = audioPlayer;
		}
		
		public static AudioPlayerEditorHelper GetInstance(AudioPlayer audioPlayer){
			if (instance == null){
				instance = new AudioPlayerEditorHelper(audioPlayer);
			}
			instance.Update();
			return instance;
		}
