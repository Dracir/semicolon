...
// TODO Make custom audio FX; or use open source ones?
...
public class AudioPlayer : MonoBehaviour {
	...
	static public AudioSource Play(string soundName, GameObject sourceObject = null, float delay = 0, AudioPlayer.SyncMode syncMode = AudioPlayer.SyncMode.None){
	...
	static public List<AudioSource> PlayRepeating(float repeatRate, string soundName, GameObject sourceObject = null, float delay = 0, AudioPlayer.SyncMode syncMode = AudioPlayer.SyncMode.None){
